...
import com.hedvig.underwriter.repository.QuoteRepository
...
class QuoteServiceImpl @Autowired constructor(
    ...
    override fun createIncompleteQuote(incompleteQuoteDto: IncompleteQuoteDto) {
        quoteRepository.save(IncompleteQuote.from(incompleteQuoteDto))
    }

//    TODO: refactor
    override fun updateIncompleteQuoteData(incompleteQuoteDto: IncompleteQuoteDto, quoteId: UUID) {

        var optionalQuote:Optional<IncompleteQuote> = quoteRepository.findById(quoteId)
        ...
        if(optionalQuote.isPresent) {
            ...
            quoteRepository.save(incompleteQuote)
        }
    }
