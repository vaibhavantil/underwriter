...
interface SwedishApartmentGuideline : BaseGuideline<ApartmentData>
...
class SwedishApartmentLivingSpaceAtLeast1Sqm : SwedishApartmentGuideline {
    ...
    override val validate = { data: ApartmentData -> data.livingSpace!! < 1 }
}
...
class SwedishApartmentHouseHoldSizeNotMoreThan6 : SwedishApartmentGuideline {
    ...
    override val validate = { data: ApartmentData -> data.householdSize!! > 6 }
}
...
class SwedishApartmentLivingSpaceNotMoreThan250Sqm : SwedishApartmentGuideline {
    ...
    override val validate = { data: ApartmentData -> data.livingSpace!! > 250 }
}
