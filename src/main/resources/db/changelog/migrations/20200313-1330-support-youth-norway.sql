...
--rollback ALTER TABLE quote_revision_norwegian_home_contents_data RENAME COLUMN is_student TO is_youth; ALTER TABLE quote_revision_norwegian_travel_data DROP COLUMN is_youth;