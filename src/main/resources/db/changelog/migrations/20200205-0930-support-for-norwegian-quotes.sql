...
CREATE TABLE quote_norwegian_home_contents_data (
...
CREATE TABLE quote_norwegian_travel_data (
    internal_id serial PRIMARY KEY,
    id uuid NOT NULL,
    ssn varchar(12) NOT NULL,
    first_name varchar(100) NOT NULL,
...
ALTER TABLE quote_revisions
    ADD COLUMN quote_norwegian_home_contents_data_id integer NULL REFERENCES quote_norwegian_home_contents_data(internal_id),
    ADD COLUMN quote_norwegian_travel_data_id integer NULL REFERENCES quote_norwegian_travel_data(internal_id),
